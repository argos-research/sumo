...
@date    2013-10-19
@version $Id: runner.py 20117 2016-03-02 09:44:13Z martintaraz $
...
def iterateGreenTimes(emissionClass, outputFile, T, MIN_GREEN, log):
    ...
    print('    <!-- vType id="t1" accel="0.8" decel="4.5" sigma="0.5" length="7.5" maxSpeed="36"/ -->	', file=fd)
    ...
    for i in range(MIN_GREEN, T - MIN_GREEN):
        ...
        print('   <vType id="t1" accel="0.8" decel="4.5" sigma="0.5" length="7.5" maxSpeed="36" aemissionClass="%s"/>' % emissionClass, file=fd)
