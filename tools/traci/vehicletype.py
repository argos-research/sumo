...
@date    2008-10-09
@version $Id: vehicletype.py 19649 2015-12-17 21:05:20Z behrisch $
...
def _getUniversal(varID, typeID):
    result = traci._sendReadOneStringCmd(
        tc.CMD_GET_VEHICLETYPE_VARIABLE, varID, typeID)
...
def subscribe(typeID, varIDs=(tc.VAR_MAXSPEED,), begin=0, end=2**31 - 1):
    ...
    """
    traci._subscribe(
        tc.CMD_SUBSCRIBE_VEHICLETYPE_VARIABLE, begin, end, typeID, varIDs)
