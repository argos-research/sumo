...
@date    2011-03-09
@version $Id: gui.py 18096 2015-03-17 09:50:59Z behrisch $
...
def _getUniversal(varID, viewID):
    result = traci._sendReadOneStringCmd(
        tc.CMD_GET_GUI_VARIABLE, varID, viewID)
...
def subscribeContext(viewID, domain, dist, varIDs=(tc.VAR_VIEW_OFFSET,), begin=0, end=2**31 - 1):
    traci._subscribeContext(
        tc.CMD_SUBSCRIBE_GUI_CONTEXT, begin, end, viewID, domain, dist, varIDs)
