...
# -*- coding: Latin-1 -*-
"""
@file    ParamEffects.py
@author  Sascha Krieg
@author  Daniel Krajzewicz
@author  Michael Behrisch
@date    2008-07-26
@version $Id: ParamEffects.py 22608 2017-01-17 06:28:54Z behrisch $
...
period = [1, 2, 5, 10, 20, 50, 100, 200, 500]
...
def main():
    ...
    for p in period:
        for q in quota:
            ...
            fd.write(str(float(s._noKnown) / float(setEdges) * 100) +
                     ";" + str(float(s._noUnknown) / float(setEdges) * 100) + ";")
            fd.write("\n")
    fd.close()
